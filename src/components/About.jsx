...
const About = () => {
  return (
    <section className="fixed inset-0 flex justify-center items-center px-4 py-8 z-30 w-screen h-screen">
      <GlassCard className="w-full max-w-3xl p-6 md:p-12 text-white space-y-8 overflow-y-auto max-h-[85vh] text-center scrollbar-custom">
        ...
        <p className="text-lg md:text-xl font-medium text-blue-300 drop-shadow p-4">
